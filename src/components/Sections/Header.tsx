    ...
    return (
      <>
        <button
          ...
          className="fixed top-2 right-2 z-40 rounded-md bg-blue-500 p-2 ring-offset-gray-800/60 hover:bg-blue-400 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 sm:hidden"
          onClick={toggleOpen}>
